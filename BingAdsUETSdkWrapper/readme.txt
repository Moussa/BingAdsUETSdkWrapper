========================================================================
    C++/WinRT BingAdsUETSdkWrapper Project Overview
========================================================================
...
void* __stdcall BingAdsUETSdkWrapper_get_activation_factory(
    std::wstring_view const& name);

void* __stdcall winrt_get_activation_factory(
    std::wstring_view const& name)
{
    void* factory = BingAdsUETSdkWrapper_get_activation_factory(name);
    if (factory)
    {
        return factory;
    }
